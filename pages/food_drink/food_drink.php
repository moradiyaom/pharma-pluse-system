...
$sql = "SELECT * FROM products WHERE category = 'food drink' ORDER BY created_at DESC";
      ...
      <?php while($row = $result->fetch_assoc()): ?>
        <div class="product-card">
          ...
          <div class="btn-group">
            ...
            <a href="all_food_drink.php?id=<?php echo $row['id']; ?>" class="btn btn-details">Details</a>
          </div>
          
        </div>
      <?php endwhile; ?>
    <?php else: ?>
      <p>No Food & Drink Found.</p>
    <?php endif; ?>
  </div>
</div>
